//! Integration tests for the BBCode parser.
//!
//! These tests verify the full parsing and rendering pipeline including
//! nesting, edge cases, URL handling, images, code blocks, and unicode.
//!
//! Note: Compatibility tests are in tests/compat.rs
//! Note: Security tests are in the security module below
